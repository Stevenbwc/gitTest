...
public class SM2Utils 
{
	...
	{
		String plainText = "message 123的digest";
		byte[] sourceData = plainText.getBytes();
		
		// 国密规范测试私钥
		String prik = "005A46376F97FC582E2FC2E6113B90001ECA77B11461D00343F11B3455DFD9BC9D";
		...
		// 国密规范测试公钥
		String pubk = "04D9280DE656ABF11D808B9C1D5A27EADE3B8C6793FEF605604F03AE5FE5495BE0794F50AB6DF3C1D7DFAF7EBFE5ED69EE940F464633668ED54119F7D7767D84A5";
...
//		boolean vs = SM2Utils.verifySign(userId.getBytes(), Base64.decode(pubkS.getBytes()), sourceData, Util.hexToByte("30440220607055C0A76197C3DE04C0E4788D97C104F74976580EB5CD8C0476B051FAF7240220233E2FF8A1D4794536037132B49126BB39C89CAB0F5D0C27503C34FE0F271261"));
		...
		String a="045D74C012305AA584FCC12FDE1D52D21051D601624F1B197F31C245BE1D7F6F820BD331D5ECF5FEFAC6F2C7EFADEB71029309B04BAABE26AF79DB609BF20B54E9520740EF5208C57629ADA0C55F53D110DF3DB7EEB2CD64F9C7D7DFDD0AEAD110DA02C0A29E377CFAB9DCD06A9F79CEB58AED";
		plainText = new String(SM2Utils.decrypt(Base64.decode(prikS.getBytes()), Util.hexToByte(a)));
